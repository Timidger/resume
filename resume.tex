...
{\textbf{Languages}: \hskip 1.4em Python, C, Go, Rust, C++, Bash, Lua, Java \\
\textbf{Technologies}: \hskip 0.3em AWS, NGINX, systemd, Git, Meson, Bazel,
Protobuf, gRPC, Wayland, Postgres, Docker, Kubernetes
\vspace{-.7em}
}
...
\begin{itemize}
	\item Writing Python and Rust for Linux Bakery team
\end{itemize}
