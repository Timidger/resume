...
\begin{itemize} \itemsep -2pt
	...
	\item Developed custom tools in Python and Rust to automate and
		administrate the distributed AMI release process
...
\begin{itemize} \itemsep -2pt
	\item Implemented removing malware extensions in the Chrome Cleanup Tool, a program that secures millions of Chrome installs on Windows computers silently every week
