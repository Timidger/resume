...
{\sl Bachelor of Science in Computer Science}, 3.0 GPA \\
...
{\textbf{Languages}: \hskip 1.4em Rust, C, C++, Python, Go, Javascript, HTML, CSS, Bash\\
\textbf{Technologies}: \hskip 0.3em tokio, Linux, Wayland, Git, Meson, Bazel,
Protobuf, gRPC, Emacs
\vspace{-.7em}
}
...
\textbf{Starry} $|$ Boston, MA\hfill February 2019 - Present\\
{\sl System Software Engineer}
\begin{itemize} \itemsep -2pt
	\item Writing Rust and C++ firmware for embedded devices that power Starry internet
    \item Using latest Rust libraries - Tokio, Futures, Failure, Serde, and proc-macro
    \item Mentoring C++ programmers as we transition to most of our code to Rust
\end{itemize}
