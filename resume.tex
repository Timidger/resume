...
\begin{itemize} \itemsep -2pt
	\item Led a company-wide reduction and cleanup of production IAM roles, leveraging AI 
		to complete the effort in 2 months with zero user impact.
	\item Replaced Terraform-based AWS resource deployments with a Go-based, 
		Kubernetes-inspired orphan cleanup system, improving control and 
		reliability of resource lifecycle management.
\end{itemize}
...
\begin{itemize} \itemsep -2pt
	...
	\item Expanded back-end API powered by Flask and
		Postgres.
...
%\begin{itemize}  \itemsep -2pt
	%\item Contributed C++ to open-source Alljoyn framework in collaboration with Allseen Alliance and Linux Foundation.
