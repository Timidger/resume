...
\section{\underline{EDUCATION}} 
 \textbf{Northeastern University} $|$ Boston, MA \hfill September 2014 \--- Present \\
...
{\textbf{Languages}: \hskip 1.4em Python, Rust, C, C++, Java, C\#, Javascript, HTML, CSS, Bash \\
\textbf{Technologies}: \hskip 0.3em Linux, Wayland, Git, Meson, Bazel, Flask, Postgres, Vi, Emacs
\vspace{-.7em}
}
...
\section{INTERESTS} \moveleft.5\hoffset\centerline{Contributing to OSS, collecting tea, playing rogue-likes}
